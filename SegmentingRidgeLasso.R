...
dataSelection <-  subset(hopmonkClv, select = c(Country,GameStrength,FavouriteSource,MinChildAge,maxRecencyCum180,
                                               MaxChildAge,NumHouseChildren,NumMaleChildrenHousehold,FrequencyLF360,
...
numeric_Variables = subset(MediumData, select = c(MaxChildAge,NumHouseChildren,NumGamesBought,NumMaleChildrenHousehold,
                                               ...
                                               maxRecencyCum,minRecencyCum30)) 
cat_variables = subset(MediumData, select = c(Country))
numeric <- decostand(na.omit(numeric_Variables), "standardize")
